...
Run timestamp: `2026-07-12T07:17:07+00:00`

Raw JSONL: [`/root/workspace/nano-vllm/docs/benchmarks/matrix/preflight_input128_seqs16.jsonl`](preflight_input128_seqs16.jsonl)

## Command

```bash
/root/workspace/nano-vllm/.venv-vllm-bench/bin/python scripts/benchmark_offline.py --engines nano_eager,nano_graph,hf,vllm --model /root/huggingface/Qwen3-0.6B --num-seqs 16 --input-len 128 --output-len 4 --warmup-runs 0 --runs 1 --dtype float16 --seed 1234 --temperature 1.0 --tensor-parallel-size 1 --max-model-len 4096 --max-num-seqs 16 --max-num-batched-tokens 32768 --gpu-memory-utilization 0.5 --output-jsonl docs/benchmarks/matrix/preflight_input128_seqs16.jsonl --output-md docs/benchmarks/matrix/preflight_input128_seqs16.md
```
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| nano_eager | eager | ok | 55.05 | 0.00 | 55.05 | 55.05 | 1.1627 | 11234 | `docs/benchmarks/matrix/preflight_input128_seqs16.jsonl` |
| nano_graph | graph | ok | 68.41 | 0.00 | 68.41 | 68.41 | 0.9356 | 11234 | `docs/benchmarks/matrix/preflight_input128_seqs16.jsonl` |
| hf | hf | ok | 159.58 | 0.00 | 159.58 | 159.58 | 0.4010 | 11234 | `docs/benchmarks/matrix/preflight_input128_seqs16.jsonl` |
| vllm | vllm | ok | 90.71 | 0.00 | 90.71 | 90.71 | 0.7056 | 11234 | `docs/benchmarks/matrix/preflight_input128_seqs16.jsonl` |
## Fairness notes
